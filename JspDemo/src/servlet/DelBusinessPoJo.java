...
public class DelBusinessPoJo extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DelBusinessPoJo() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Integer businessIdi = Integer.parseInt(BusinessId.trim());
		BusinessBean bb= new BusinessBean();
		BusinessPojo bp = bb.gogetOneBusiness(businessIdi);
		
		FileTools ft = new FileTools();
		String filepathtype="listfile";		 
		String filepath =ft.gogetFilePath(filepathtype);		
		ft.executeWriteFileDelLine(filepath, businessIdi.toString());
